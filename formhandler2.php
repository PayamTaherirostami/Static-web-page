...
mail ('payamt83@gmail.com', $subject, $body, $from);

header('Location: email-blast.html'); // replace "thx.html" with the name and path to your actual thank you page